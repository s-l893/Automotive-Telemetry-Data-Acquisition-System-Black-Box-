...
int main(void)
{
    ...
    {
        printf("  WARNING: CAN start failed - transceiver disabled\r\n");
        // Pull STM32 TX pin low-impedance to recessive state
        // Reconfigure PA12 as output high to force recessive
