 ...
 * File generated by cursor but core functions written by me, alongside some other helper functions for debugging purposes before an electrical fault was exposed.
 */
